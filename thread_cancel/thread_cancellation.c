...
write_into_file(void *arg){
    ...
    //this API doesn't take any thread_handle since it's only upto thread itself to set this attributes
    //Had there been any thread_handle argument, any other thread set cancelstate of thread
    //Any posix api which doesn't include thread_handle, it's effect is 
